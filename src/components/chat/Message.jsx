/**
 * Message.jsx
 * Renders a single chat message (text, image, gif, gift, system).
 * Right-click opens MsgMenu context menu.
 */
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="msg-bubble">
            ...
            {!['image', 'gif', 'gift'].includes(msg.type) && renderContent(msg.content)}
          </div>
        </div>
      </div>
